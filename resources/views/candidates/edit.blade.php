...
<div class="card">
  <div class="card-header">
    <i class="fa fa-plus"></i><b> UPDATE CANDIDATE</b>
  </div>
  <div class="row">
    <div class="col-sm-2"></div>
    <div class="col-sm-8">
      <form class="form-horizontal" action="/candidates/{{$candidates[0]->id}}/update" method="POST">
        @csrf
        <div class="card-body">
          ...
          <div class="form-group row">
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="Full Name" value="{{$candidates[0]->name}}" required>
              </div>
            </div>
          </div>
          <div class="form-group row">
              ...
              <div class="form-group">
                <label for="full_name">Election Name *</label>
                    <select class="form-control" name="election_name" id="" required>
                        <option value="{{$candidates[0]->election_id}}">{{$candidates[0]->title}}</option>
